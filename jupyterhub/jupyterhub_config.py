...
# Defines the admins
c.Authenticator.admin_users = {'jhadmin', 'mingchung','jerry'}
...
c.DockerSpawner.allowed_images = {'Tensorflow-CPU':'jupyter/tensorflow-notebook', 
                                  'Tensorflow + Pytorch(GPU)':'cschranz/gpu-jupyter:v1.5_cuda-11.6_ubuntu-20.04_python-only'
                                  }
...
c.DockerSpawner.volumes = {
          '/mnt/562489132488F6F1/mounted_user/{username}/': {'bind': mounted_user_workdir, 'mode': 'rw'},
          '/mnt/2fdccbde-260b-4f63-81ec-0fb52ec08d94/shared/': {'bind': os.path.join(notebook_dir, 'SHARED'), 'mode': 'ro'}
}
